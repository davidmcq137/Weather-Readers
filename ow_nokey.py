...
#       rain3h=raw_api_dict.get('rain').get('3h')
...
#   print('Rain 3H: {}'.format(data['rain3h']))
    print('Pressure: {}'.format(inHg_pressure))
...
if __name__ == '__main__':
    try:
        data_output(data_organizer(data_fetch(url_builder(5123118))))
    except IOError:
        print('Error getting weather datat')
